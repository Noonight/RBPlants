...
class MenuProfileFragment : NavigationFragment(), MenuProfileView
{
    @Inject
    lateinit var presenter: MenuProfilePresenter
    ...
    {
        return AutoLayoutNavigationBuilder.navigation(R.layout.fragment_menu_profile)
            .includeToolbar()
            .includeBottomNavigation()
            .toolbarTitleRes(R.string.menu_profile)
